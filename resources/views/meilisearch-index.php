...
<div class="wrap">
	...
	if ($index = wcms_get_index()) :
		...
		echo '<a class="button" href="/wp/wp-admin/admin.php?page=woocommerce-meilisearch-index&action=re-index&index=' . $indexUid . '">Re-index</a>';

		echo '<a class="button" href="/wp/wp-admin/admin.php?page=woocommerce-meilisearch-index&action=clear&index=' . $indexUid . '">Clear index</a>'; ?>
	...
	<?php
		...
		echo 'Can\'t create the MeiliSearch Client. <a href="/wp/wp-admin/admin.php?page=woocommerce-meilisearch-settings">Check the Server Settings.</a>';
	endif; ?>
</div>