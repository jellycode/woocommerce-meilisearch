(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.MeiliSearch = factory());
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4
                /*yield*/
                , this.httpRequest.post(url, __assign(__assign({}, options), {
                  uid: uid
                }))];
              ...
              case 1:
                ...
                return [2
                /*return*/
                , new Index(this.config, index.uid)];
            }
          });
        });
      }; ///
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4
                /*yield*/
                , this.httpRequest.get(url).then(function () {
                  return true;
                })];
